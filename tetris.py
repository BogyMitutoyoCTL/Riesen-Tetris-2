...
def run_game():
    ...
    while not game_over:
        ...
        while countdown > 0:
            ...
            if collision_detector.check_if_block_at_wall_right(color_playground, current_block,
                ...
                if collision_detector.collision(color_playground, current_block, current_block_position[0],
                                                current_block_position[1] + 1) == True:
